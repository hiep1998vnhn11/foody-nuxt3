...
const styles = {
  ...
  "components/ActionSheet/index.vue": () => import('./_nuxt/index-styles.9fa8a6de.mjs').then(interopDefault),
  "components/Builder/Navbar.vue": () => import('./_nuxt/Navbar-styles.7b74e311.mjs').then(interopDefault)
};
